...
def test_create_and_get_todo(todo_client: BaseApiClient, managed_todo_id: int):
    """
...
def test_create_todo_default_values(todo_client: BaseApiClient):
    """
...
def test_delete_todo(todo_client: BaseApiClient):
    """
...
def test_create_todo_duplicate_id(todo_client: BaseApiClient, managed_todo_id: int):
    """
...
def test_create_todo_validation_error(todo_client: BaseApiClient, missing_field: str):
    """
...
def test_delete_non_existent_todo(todo_client: BaseApiClient):
    """
